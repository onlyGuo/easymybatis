<p align="center">
  <img alt="logo" height=320 width=640 src="https://www.easymybatis.com/logo.png">
</p>
...
#### 通过Gradle直接引入
````
implementation 'com.easymybatis.freamwork:spring-easymybatis-core:0.3.5.RELEASE'
````
